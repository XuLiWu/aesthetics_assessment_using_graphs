...
class Avg_Pool_FC(Graph_Base):
    ...
    def forward(self, data, phase):
        ...
        # x_01 = self.set2set_01(x, batch)
        # x_02 = self.set2set_02(self.lin02(data.x), batch)
...
class GAT_x1_GATP(Graph_Base):
    def __init__(self, in_features=16928, hidden=2048, heads=8, out_features=3072, edge_dim=2):
